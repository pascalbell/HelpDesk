...
```
A  value closer to -1 indicates a high negative correlation, indicating that across patient samples, as one need appears, another tends to not appear. A value around 0 indicates little to no correlation between two needs. A value closer to 1 indicates a high positive correlation between two needs—they often appear with each other. 
