...
#change dataset here
data <- read_csv("~/workspace/RStudio/helpdesk/Data csv/Data 1:10:26.csv") 

firstSecond <- data |>
  filter(datescreen >= "2021-8-01" & datescreen < "2023-08-01")
...
# date filter
data <- data |>
  filter(datescreen >= "2025-08-01" & datescreen < "2026-01-01")
