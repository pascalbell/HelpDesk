...
#change dataset here
data <- read_csv("~/workspace/RStudio/helpdesk/Data csv/Data 10:21:24.csv") 

data <- data |>
  filter(datescreen >= "2022-01-01" & datescreen <= "2024-10-16")
...
```{r}
semester_23F <- data |>
  filter(datescreen >= "2024-05-20" & datescreen <= "2024-08-11")
```
